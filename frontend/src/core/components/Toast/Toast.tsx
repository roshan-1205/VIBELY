...
import { useToastStore, Toast as ToastType } from './toast.store'
...
const ToastComponent: React.FC<ToastProps> = ({ toast }) => {
  ...
  const getToastStyles = () => {
    const baseStyles = 'flex items-center gap-3 p-4 rounded-lg shadow-lg border backdrop-blur-sm transition-all duration-300 ease-in-out'
